    ...
    try:
        ...
        # local audio file
            ...
            if os.path.exists(song_input):
                #code for output folder, creating a folder with the base name of our input file
                base_name = os.path.basename(song_input)
                song_name,_ = os.path.splitext(base_name)
                song_id = song_name
                #end of code modification, original code below:
